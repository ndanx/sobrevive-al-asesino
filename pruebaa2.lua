...
-------------------------------------------------------------------
-- LÓGICA DE AUTO REVIVE (ANÁLISIS TOTAL + RETORNO)
-------------------------------------------------------------------
task.spawn(function()
    while true do
...
Tabs.Movement:AddToggle("ReviveT", {
    ...
    Description = "Analiza a todos. Va y vuelve automáticamente.",
    Default = false
...
game:GetService("RunService").Stepped:Connect(function()
    ...
    -- ESP Logic (K Mayúscula para Killer)
...
Window:SelectTab(1)
Fluent:Notify({Title = "STK Premium", Content = "Auto Revive por Atributos Listo", Duration = 5})
