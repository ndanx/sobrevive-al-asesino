...
local ReviveToggle = Tabs.Movement:AddToggle("ReviveT", {
    Title = "Auto Revive",
    Description = "Check de Atributo 'downed'",
    Default = false
})
            ...
            pcall(function()
                ...
                for _, v in pairs(Players:GetPlayers()) do
                    if v ~= lp and v.Character and v.Character:FindFirstChild("HumanoidRootPart") then
                        -- Check en Player y en Character (como te dijeron: "inside player")
                        local isDowned = v:GetAttribute("downed") == true or v.Character:GetAttribute("downed") == true
