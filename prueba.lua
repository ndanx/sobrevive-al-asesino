            ...
            pcall(function()
                ...
                for _, v in pairs(Players:GetPlayers()) do
                    if v ~= lp and v.Character and v.Character:FindFirstChild("HumanoidRootPart") then
                        -- DOBLE CHECK: Busca el atributo en el Player O en el Character
                        local downedInPlayer = v:GetAttribute("downed")
                        local downedInChar = v.Character:GetAttribute("downed")
                        
                        -- Si cualquiera de los dos es verdadero:
                        if downedInPlayer == true or downedInChar == true then
