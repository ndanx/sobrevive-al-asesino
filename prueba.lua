...
local Options = {
    ...
    InfJump = false,
    WalkSpeed = 16,
    AutoRevive = false -- Variable para el nuevo toggle
}
...
-- AGREGAMOS EL TOGGLE DE AUTO REVIVE
Tabs.Movement:AddToggle("ReviveT", {
    Title = "Auto Revive",
    Description = "Lógica de Rawscripts (Downed/HelpSymbol)",
    Default = false
...
Window:SelectTab(1)
Fluent:Notify({Title = "Survive The Killer", Content = "Hub cargado correctamente.", Duration = 5})
